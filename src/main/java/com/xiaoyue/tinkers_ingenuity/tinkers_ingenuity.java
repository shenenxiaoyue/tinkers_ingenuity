...
import com.xiaoyue.tinkers_ingenuity.Effect.Event.ELivingEvent;
import com.xiaoyue.tinkers_ingenuity.Register.BaseItems;
import com.xiaoyue.tinkers_ingenuity.Register.Effects;
import com.xiaoyue.tinkers_ingenuity.Register.Fluids;
...
@Mod("tinkers_ingenuity")
public class tinkers_ingenuity
{
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    public static final String MOD_ID = "tinkers_ingenuity";

    public tinkers_ingenuity()
    {
        IEventBus eventBus = FMLJavaModLoadingContext.get().getModEventBus();

        MinecraftForge.EVENT_BUS.register(new ELivingEvent());

        BaseItems.ITEMS.register(eventBus);
        Effects.EFFECT.register(eventBus);
